...
## read:write = 3:1
# ./statesimul.out NO NO NO TASKGEN 4 0.3 -1 0.05 0.95 1
## read:write = 2:2
# ./statesimul.out NO NO NO TASKGEN 4 0.3 -1 0.05 0.95 2
## read:write = 1:3
# ./statesimul.out NO NO NO TASKGEN 4 0.3 -1 0.05 0.95 3
## read:write = 0:4
# ./statesimul.out NO NO NO TASKGEN 4 0.3 -1 0.05 0.95 4
### WORKLOAD GENERATOR
./statesimul.out NO NO NO WORKGEN 4 0.3 -1 0.05 0.95 3
