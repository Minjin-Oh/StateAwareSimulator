...
../../statesimul.out NO NO SKIPRR nogen 3 0.15 -1 -1 -1
...
../../statesimul.out YOUNGGC GREEDYW SKIPRR nogen 3 0.2 -1 -1 -1
../../statesimul.out UTILGC HOTW RR005 nogen 3 0.2 -1 -1 -1
../../statesimul.out NO NO BASE005 nogen 3 0.2 -1 -1 -1
mkdir ./testres
mv ./*.csv ./testres
