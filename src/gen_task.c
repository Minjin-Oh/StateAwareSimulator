...
rttask* generate_taskset2(int tasknum, float tot_util, int addr, float* result_util, int cycle){
    //params
    //what about address??
    float utils[tasknum];
    float util_task[2];
...
rttask* generate_taskset(int tasknum, float tot_util, int addr, float* result_util, int cycle)
{
    ...
    // const int wp_tbl[1] = {20000};
    // const int rp_tbl[1] = {20000};
    // const int wn_tbl[1] = {1};
    // const int rn_tbl[1] = {1};

    const int wp_tbl[4] = {30000, 30000, 30000, 30000};
    const int rp_tbl[4] = {30000, 30000, 30000, 30000};
    const int wn_tbl[4] = {7,7,7,7};   // 예: 전부 30 page
    const int rn_tbl[4] = {7,7,7,7};   // 예: 전부 50 page
