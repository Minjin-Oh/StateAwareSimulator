...
./statesimul.out NO NO NO TASKGEN 4 0.3 -1 0.05 0.95 -1 0
./statesimul.out NO NO NO WORKGEN 4 0.3 -1 0.05 0.95 -1 0
...
./statesimul.out NO NO SKIPRR nogen 4 0.3 -1 0.05 0.95 -1 0
...
./statesimul.out NO MOTIVALLY SKIPRR nogen 4 0.3 -1 0.05 0.95 -1 0
...
./statesimul.out UTILGC GRADW RR005 nogen 4 0.3 -1 0.05 0.95 -1 0
...
./statesimul.out NO NO BASE005 nogen 4 0.3 -1 0.05 0.95 -1 0
#mkdir ./testres
#mv ./*.csv ./testres
