...
./statesimul.out NO NO SKIPRR nogen 4 0.3 -1 -1.0 -1.0 -1 -1
...
./statesimul.out NO MOTIVALLY SKIPRR nogen 4 0.3 -1 -1.0 -1.0 -1 -1
...
./statesimul.out UTILGC GRADW RR005 nogen 4 0.3 -1 -1.0 -1.0 -1 -1
...
./statesimul.out NO MOTIVALLY BASE005 nogen 4 0.3 -1 -1.0 -1.0 -1 -1
#mkdir ./testres
#mv ./*.csv ./testres
